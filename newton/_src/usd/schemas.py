...
def _newton_legacy_joint_state_attr(legacy_name: str):
    """Return a getter that reads a legacy Newton joint state attr with a deprecation warning."""

    def _getter(prim: Usd.Prim) -> float | None:
        value = usd.get_attribute(prim, legacy_name)
        if value is not None:
            warnings.warn(
                f"'{legacy_name}' on joint prim is deprecated.",
                DeprecationWarning,
                stacklevel=4,
            )
            return float(value)
    ...
    mapping: ClassVar[dict[PrimType, dict[str, SchemaAttribute]]] = {
        ...
        PrimType.JOINT: {
            ...
            "limit_linear_ke": SchemaAttribute(
                ...
                None,
                usd_value_getter=_newton_legacy_joint_limit_attr("newton:linear:limitStiffness", "newton:limitStiffness"),
            ),
            "limit_angular_ke": SchemaAttribute(
                "newton:angular:limitStiffness",
                None,
                usd_value_getter=_newton_legacy_joint_limit_attr("newton:angular:limitStiffness", "newton:limitStiffness"),
            ),
            ...
            # Non-schema per-DOF initial state attrs (deprecated)
            "angular_position": SchemaAttribute(
                "newton:angular:position",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:angular:position"),
            ),
            "linear_position": SchemaAttribute(
                "newton:linear:position",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:linear:position"),
            ),
            "rotX_position": SchemaAttribute(
                "newton:rotX:position",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotX:position"),
            ),
            "rotY_position": SchemaAttribute(
                "newton:rotY:position",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotY:position"),
            ),
            "rotZ_position": SchemaAttribute(
                "newton:rotZ:position",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotZ:position"),
            ),
            "angular_velocity": SchemaAttribute(
                "newton:angular:velocity",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:angular:velocity"),
            ),
            "linear_velocity": SchemaAttribute(
                "newton:linear:velocity",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:linear:velocity"),
            ),
            "rotX_velocity": SchemaAttribute(
                "newton:rotX:velocity",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotX:velocity"),
            ),
            "rotY_velocity": SchemaAttribute(
                "newton:rotY:velocity",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotY:velocity"),
            ),
            "rotZ_velocity": SchemaAttribute(
                "newton:rotZ:velocity",
                0.0,
                usd_value_getter=_newton_legacy_joint_state_attr("newton:rotZ:velocity"),
            ),
        },
        PrimType.SHAPE: {
            # Mesh
